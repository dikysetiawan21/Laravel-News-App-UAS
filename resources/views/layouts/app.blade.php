...
@if(Auth::check() && Auth::user()->role == 'admin')
    <li class="nav-item">
        <a class="nav-link" href="{{ route('users.index') }}"> {{-- Link ke manajemen user --}}
...
{{-- Admin dan Editor bisa melihat menu Approval --}}
...
{{-- Admin dan Wartawan bisa melihat menu Berita --}}
@if(Auth::check() && (Auth::user()->role == 'admin' || Auth::user()->role == 'wartawan'))
    <li class="nav-item">
...
{{-- Menu Berita Publik (untuk semua user yang login) --}}
@if(Auth::check())
<li class="nav-item">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Nav Item - User Information / Login Button -->
                        @guest
                            <li class="nav-item">
